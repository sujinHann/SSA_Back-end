			...
			<div class="col-lg-4 text-center ">
				<div class="d-inline-flex align-items-center justify-content-center">
					<a href="/main" class="navbar-brand"> <img id="logo_119"
						src="./resources/img/119 Logo.png" alt="">
					</a>
				</div>
			</div>
		...
		<div class="collapse navbar-collapse navbar-scarlet"
			...
			<div class="navbar-nav ms-auto mx-lg-auto py-0">
				<a href="/main" class="nav-item nav-link ">Main</a> <a
					href="/state_check" class="nav-item nav-link">상태확인</a> <a
							...
							<div class="accordion-item">
								<h2 class="accordion-header" id="headingOne">
									<button class="accordion-button" type="button"
										...
										aria-expanded="true" aria-controls="collapseOne" disabled="true">지역</button>
								</h2>
