    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse navbar-scarlet" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="/state_check" class="nav-item nav-link active">상태확인</a>
                ...
                <div class="d-flex justify-content-center">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <!-- 여기에 팀 넣어 -->
                            <a class="dropdown-item" href="#">한수진팀</a>
                            <a class="dropdown-item" href="#">두수진팀</a>
                            <a class="dropdown-item" href="#">삼수진팀</a>
                        </div>
                    </div>
                </div>
                <!-- 드롭다운 끝 -->
                    ...
                    <div class="team-item">
                        ...
                        <div class="bg-dark border-inner text-center p-4">
                            <div class="state_check_state">
                                <h4 class="text-uppercase text-primary">한수진</h4>
                                &nbsp;&nbsp;
                                <h4 class="text-uppercase text-primary">|</h4>
                                &nbsp;&nbsp;
                                <h4 class="text-uppercase text-primary">대기</h4>
                            </div>
                            ...
                            <div class="no-g"
                                ...
                                <div style="padding-right: 0px;">
                                    <!-- 심장박동 수정 예정 -->
                                    <a class="btn" href="#" style="padding-right: 0px;padding: 0;margin: 0;"><i
                                ...
                                <div class="">
                                    <a class="btn" href="/monitoring" style="padding: 0;margin: 0;"><i
